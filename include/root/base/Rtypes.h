...
#include "./core/RtypesCore.h"
// #include "DllImport.h" // included via RtypesCore.h, not used here

#ifndef R__LESS_INCLUDES
#include <cstdio>
#include "./core/strtok.h"     // provides R__STRTOK_R with <cstring> include
#include "./core/strlcpy.h"    // part of string.h on systems that have it
#include "./core/snprintf.h"   // part of stdio.h on systems that have it
#include <type_traits>
#endif
